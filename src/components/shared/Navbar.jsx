            ...
            <div className='w-10/12 mx-auto p-2 mt-3  flex flex-col sm:flex-row justify-between items-center gap-5'>
                ...
                <div>
                    <ul className='flex gap-4 items-center'>
                        <li className='bg-linear-to-r from-red-500 to-blue-500 bg-clip-text text-transparent'><Link href={'/'}>Home</Link></li>
                        <li className="bg-linear-to-r from-red-500 to-blue-500 bg-clip-text text-transparent"><Link href={'/animals'}>All Animals</Link></li>
                    </ul>
                </div>
